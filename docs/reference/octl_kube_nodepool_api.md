...
```
  ...
  -h, --help             help for api
      --project string   Name or ID of project (default "dev")
```
...
* [octl kube nodepool api List](octl_kube_nodepool_api_List.md)	 - 
* [octl kube nodepool api Update](octl_kube_nodepool_api_Update.md)	 - 
