## octl iaas api DeleteListenerRule
...
```
octl iaas api DeleteListenerRule [flags]
```
...
```
      ...
      --ListenerRuleName string   [REQUIRED] The name of the rule you want to delete.
  -h, --help                      help for DeleteListenerRule
```
