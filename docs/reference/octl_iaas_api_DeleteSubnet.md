...
```
octl iaas api DeleteSubnet [flags]
```
...
```
      ...
      --SubnetId string   [REQUIRED] The ID of the Subnet you want to delete.
  -h, --help              help for DeleteSubnet
```
