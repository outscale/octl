## octl iaas api CreateRouteTable
...
```
octl iaas api CreateRouteTable [flags]
```
...
```
      ...
      --NetId string   [REQUIRED] The ID of the Net for which you want to create a route table.
  -h, --help           help for CreateRouteTable
```
