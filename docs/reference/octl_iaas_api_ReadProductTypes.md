## octl iaas api ReadProductTypes
...
```
octl iaas api ReadProductTypes [flags]
```
...
```
      ...
      --Filters.ProductTypeIds strings   The IDs of the product types.
  ...
  -h, --help                             help for ReadProductTypes
```
