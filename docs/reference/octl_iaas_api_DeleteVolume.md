...
```
octl iaas api DeleteVolume [flags]
```
...
```
      ...
      --VolumeId string   [REQUIRED] The ID of the volume you want to delete.
  -h, --help              help for DeleteVolume
```
