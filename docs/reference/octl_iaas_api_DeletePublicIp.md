...
```
      ...
      --PublicIpId string   The ID representing the association of the public IP with the VM or the NIC.
  -h, --help                help for DeletePublicIp
```
