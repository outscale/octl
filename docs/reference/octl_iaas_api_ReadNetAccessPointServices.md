## octl iaas api ReadNetAccessPointServices
...
```
octl iaas api ReadNetAccessPointServices [flags]
```
...
```
      ...
      --Filters.ServiceIds strings     The IDs of the services.
  ...
  -h, --help                           help for ReadNetAccessPointServices
```
