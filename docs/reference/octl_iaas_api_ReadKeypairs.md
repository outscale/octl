...
```
octl iaas api ReadKeypairs [flags]
```
...
```
      ...
      --Filters.KeypairFingerprints strings   The fingerprints of the keypairs.
      --Filters.KeypairIds strings            The IDs of the keypairs.
      --Filters.KeypairNames strings          The names of the keypairs.
      --Filters.KeypairTypes strings          The types of the keypairs (ssh-rsa, ssh-ed25519, ecdsa-sha2-nistp256, ecdsa-sha2-nistp384, or ecdsa-sha2-nistp521).
