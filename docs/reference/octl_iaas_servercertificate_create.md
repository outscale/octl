...
```
      --body string          [REQUIRED] The file storing the PEM-encoded X509 certificate.
      --chain string         The file storing the PEM-encoded intermediate certification authorities.
  -h, --help                 help for create
      ...
      --private-key string   [REQUIRED] The file storing the PEM-encoded private key matching the certificate.
```
