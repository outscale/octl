## octl iaas api DeleteExportTask
...
```
octl iaas api DeleteExportTask [flags]
```
...
```
      ...
      --ExportTaskId string   [REQUIRED] The ID of the export task to delete.
  -h, --help                  help for DeleteExportTask
```
