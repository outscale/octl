...
```
      ...
      --api-name strings      The names of the APIs of the logged calls (always oapi for the OUTSCALE API).
      --call-name strings     The names of the logged calls.
      --date-after osctime    The date and time, or the date, after which you want to retrieve logged calls, in ISO 8601 format (for example, 2020-06-14T00:00:00.000Z or 2020-06-14).
      --date-before osctime   The date and time, or the date, before which you want to retrieve logged calls, in ISO 8601 format (for example, 2020-06-30T00:00:00.000Z or 2020-06-14).
  -h, --help                  help for list
      --ip-address strings    The IPs used for the logged calls.
      --request-id strings    The request IDs provided in the responses of the logged calls.
      --status-code ints      The HTTP status codes of the logged calls.
