## octl iaas api DeleteRouteTable
...
```
octl iaas api DeleteRouteTable [flags]
```
...
```
      ...
      --RouteTableId string   [REQUIRED] The ID of the route table you want to delete.
  -h, --help                  help for DeleteRouteTable
```
