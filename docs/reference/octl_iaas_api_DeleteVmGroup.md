...
```
octl iaas api DeleteVmGroup [flags]
```
...
```
      ...
      --VmGroupId string   [REQUIRED] The ID of the VM group you want to delete.
  -h, --help               help for DeleteVmGroup
```
